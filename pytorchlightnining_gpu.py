# https://pytorch-lightning.readthedocs.io/en/stable/accelerators/gpu.html
...
def main():
    ...
    trainer = pl.Trainer(gpus=2, plugins=DDPSpawnPlugin(find_unused_parameters=False),
                         max_epochs=5000, log_every_n_steps=5,
